...
%--------------------------------------------------------------------------
function triggered = get_trigger(obj, base_level, n_trigger, chan_nr, chan_type)
      ...
      %
      % n_trigger : integer
      %   if > 0: Wait for trigger number n_trigger instead of first trigger  
      %
      ...
      %   The default is 'FIO'.
        ...
        if n_trigger == 1
            ...
            fprintf('\nWaiting for %i th trigger...\n', n_trigger)
        end

        triggered = obj.trigger_subsystem.wait_for_intrigger(base_level, n_trigger, chan_nr, chan_type);
