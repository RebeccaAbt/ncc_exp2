classdef Datapixx < o_ptb.subsystems.audio.Base
  ...
  methods
    ...
    function init(obj)
      ...
      obj.buffer_address = obj.config.buffer_address;
    ...
    function prepare(obj, stim, delay, mix)
      ...
      obj.n_samples_in_buffer = max(offset_sample, obj.n_samples_in_buffer);
      
      if isempty(obj.buffer)
        obj.buffer = zeros(2, 60 * 48000);
      end %if
    ...
    function schedule(obj)
      obj.buffer = obj.buffer(:, 1:obj.n_samples_in_buffer);  
