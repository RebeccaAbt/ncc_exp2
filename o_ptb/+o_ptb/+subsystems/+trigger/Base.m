...
%--------------------------------------------------------------------------    
function wait_for_intrigger(obj, base_level, n_trigger, chan_nr, chan_type)
        warning('Waiting for Input Trigger is not implemented for this trigger system');
    end %function   
    function intrigger_status(obj, chan_nr, n_trigger)
        warning('Waiting for Input Trigger is not implemented for this trigger system');
    end %function 
%-------------------------------------------------------------------------- 
